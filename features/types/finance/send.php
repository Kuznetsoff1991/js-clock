...
$soname = $_POST['user_soname'];
$review = $_POST['user_rev'];
...
$mail->Body    = "Пользователь оставил свои данные <br> Имя: $name <br>Телефон: $phone <br>Фамилия: $soname <br>Отзыв: $review <br>Откуда: $place1 <br>Куда: $place2"; // Текст письма
